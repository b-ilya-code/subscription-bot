...
public class ParserTest {
    ...
    public void testGitHubParserWithValidLink() {
        String url = "https://github.com/b-ilya-code/java-tasks/blob/master/build.gradle";
        String expected = "GitHubData[username=b-ilya-code, repository=java-tasks]";
    ...
    public void testGitHubParserWithInvalidLink() {
        String url = "https://ficko.com/b-ilya-code/tinkoff-java-course-2077";
        Parser gitHubParser = new GitHubParser();
